...
parser.add_argument('--momentum', default=0.9, type=float, metavar='M',
                    help='momentum')
parser.add_argument('--late-fusion', type=str2bool, nargs='?', const=True)
parser.add_argument('--pix-file', type=str, default='./colormap_coarse.csv')
parser.add_argument('--transform-type', type=str, default='fc')
parser.add_argument('--consensus-type', type=str, default='sum')
...
parser.add_argument('--random-pick', type=str2bool, nargs='?', const=True)
parser.add_argument('--center-loss', type=str2bool, nargs='?', const=False)
parser.add_argument('--late-fusion-type', type=str, default='avg')
parser.add_argument('--rotate', type=str2bool, nargs='?', const=False)
parser.add_argument('--transpose-output', type=str2bool, nargs='?', const=True)
...
parser.add_argument('--view-bias', default=0, type=int, metavar='N')
parser.add_argument('--fc-dim', default=256, type=int, metavar='N')
parser.add_argument('--segSize', default=256, type=int, metavar='N')
parser.add_argument('--test-view-num', default=4, type=int, metavar='N')
...
parser.add_argument('--test-views', type=int, default=8)
...
parser.add_argument('--weights', type=str,
                    default='/data/vision/oliva/scenedataset/syntheticscene/visual-navi/examples/cognitive_mapping/model/resnet_view8_scope2_epoch_30_checkpoint.pth.tar')
